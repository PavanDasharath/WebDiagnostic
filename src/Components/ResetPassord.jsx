...
// import { Paper, TextField, Snackbar, withStyles } from '@mui/material';
...
//       );
//       this.setState({
//         message: `Fill in the field - ${`${!form.userName ? 'Username, ' : ''}${
...
import { Paper, TextField, Snackbar, Button } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
import MuiAlert from '@mui/material/Alert';
...
const PassChanger = props => {
  ...
  useEffect(() => {
    props.passView(true);
    return () => {
      props.passView(false);
    };
  }, [props]);

  const changePassword = async data => {
    // You can implement your changePassword logic here
    // return axios.post(``, data).then(response => response.data);
  };
  ...
  const clickField = (field, value) => {
    // Click field logic here
  };

  const blurField = field => {
    // Blur field logic here
  };

  const setFieldValue = (field, value) => {
    // Set field value logic here
  };
